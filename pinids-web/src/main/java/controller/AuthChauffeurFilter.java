...
public class AuthChauffeurFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		String indexURI = request.getContextPath() + "/chauffeur/tache/list.jsf";
		String registerURI = request.getContextPath() + "/register.jsf";

		boolean loggedIn = SessionUtils.getCurrentUser() != null
				&& SessionUtils.getCurrentUser().getRole().equals(RoleUser.chauffeur);
